...
return [
    ...
    'DC location' => 'Расположение',
    'Sale' => 'Продажа',
    'Charges' => 'Списания',
    'Installment is ongoing' => 'Выплата продолжается',
    'Installment is finished' => 'Выплата завершена',
    'Part is bought out' => 'Деталь выкуплена',
    'Installment is interrupted' => 'Выплата прервана',
    'Installment state is ambiguous' => 'Состояние выплаты неопределенно',
    'Installment plan is deleted' => 'План выплаты удален',
    'Installment start' => 'Начало выплаты',
    'Installment end' => 'Конец выплаты',
    'Periods' => 'Периоды',
    'Total sum' => 'Общая сумма',
    'Monthly sum' => 'Ежемесячный платёж',
